#!/usr/bin/env python3
"""
Script pour régénérer complètement le code Flutter avec les services de la base de données.
"""
...
def generate_flutter_code(services):
    """Génère le code Flutter pour les services en utilisant des guillemets doubles"""
  ...
  static List<Service> _getDefaultServices() {
    ...
    for service in services:
        # Utiliser des guillemets doubles pour éviter les problèmes d'apostrophes
...
def main():
    print("🔧 Régénération complète du code Flutter pour les services...")
    ...
    try:
        with open('/Users/macbook/Desktop/fibaya_mina/lib/prestataire_app/services/service_service.dart', 'w', encoding='utf-8') as f:
            f.write(new_content)
        print("✅ Fichier service_service.dart régénéré avec succès!")
    except Exception as e:
