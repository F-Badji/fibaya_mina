...
import 'our_commitment_screen.dart';
import 'our_clients_screen.dart';
import 'our_partners_screen.dart';
import 'our_faq_screen.dart';
              ...
              if (_showAllAboutItems) ...[
                _buildAboutCard(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const OurCommitmentScreen(),
                    ),
                  ),
                ),
                _buildAboutCard(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const OurClientsScreen(),
                    ),
                  ),
                ),
                _buildAboutCard(
                ...
                _buildAboutCard(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const OurFaqScreen(),
                    ),
                  ),
                ),
              ],
  ...
  Widget _buildLanguageOption(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? fibayaGreen.withOpacity(0.1) : Colors.white,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
        ...
        child: Row(
          children: [
            Icon(
              Icons.language,
              color: isSelected ? fibayaGreen : Colors.grey[600],
              size: 20,
            ),
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  fontSize: 16,
                  color: isSelected ? fibayaGreen : Colors.black,
                  fontWeight: isSelected ? FontWeight.w600 : FontWeight.normal,
                ),
              ),
            ),
            if (isSelected)
              Icon(Icons.check_circle, color: fibayaGreen, size: 20),
          ],
        ),
      ),
    );
