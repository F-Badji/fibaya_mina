...
class _OurServicesScreenState extends State<OurServicesScreen>
  ...
  final List<Map<String, dynamic>> _serviceCategories = [
    ...
    },
    {
      ...
      'color': Colors.red,
      'services': ['Infirmier à domicile', 'Kinésithérapeute', 'Podologue'],
    },
    {
    ...
    },
    {
      ...
      'icon': Icons.security,
      'color': Colors.grey,
      'services': ['Agent de sécurité', 'Garde du corps', 'Surveillant'],
    },
    {
      'category': '🌱 AGRICULTURE & ÉLEVAGE',
      'icon': Icons.agriculture,
      'color': Colors.green,
      'services': ['Agriculteur', 'Éleveur', 'Vétérinaire', 'Ouvrier agricole'],
    },
    {
