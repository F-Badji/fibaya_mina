...
class PrestataireSmsVerificationScreen extends StatefulWidget {
  ...
  @override
  State<PrestataireSmsVerificationScreen> createState() =>
      _PrestataireSmsVerificationScreenState();
}

class _PrestataireSmsVerificationScreenState
    extends State<PrestataireSmsVerificationScreen>
  ...
  void _startStatusCheck() {
    ...
    startStatusCheck(widget.phone, widget.countryCode);
  }
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      // Simulate API call to verify code and check admin approval
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.arrow_back, color: Color(0xFF065b32)),
        ),
      ),
      body: SafeArea(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                            ...
                            const Center(
                              child: Column(
                                children: [
                                  ...
                                  SizedBox(height: 8),
                                  Text(
                                    'Entrez le code à 4 chiffres envoyé sur votre numéro',
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: Colors.grey,
                                    ),
                    ...
                    const SizedBox(height: 40), // Espacement au lieu de Spacer
                    // Footer
                    Text(
